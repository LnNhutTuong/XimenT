    ...
    <div class="flex items-center justify-between">
        ...
        <div>            
            ...
            <button id="open-create-category" type="button"
                ...
                hover:bg-white hover:text-[#09090a] border hover:border-[#09090a] transition-all">
                Thêm danh mục
            </button>
        </div>
                            ...
                            <td class="px-6 py-4 text-center">
                             ...
                             <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('admin.categories.edit', $category->id) }}" class="inline-flex items-center gap-1.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold px-3 py-1.5 rounded-lg transition-all shadow-sm">
                                    ...
                                    <form action="{{ route('admin.categories.destroy', $category->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc muốn xoá danh mục này?')">
                                        @csrf
                                        @method('DELETE')
