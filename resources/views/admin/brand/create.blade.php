<x-my-modal name="create-brand-modal" maxWidth="md">
    <x-slot name="title">
        Thêm thương hiệu
    </x-slot>
    ...
    <x-slot name="footer">   <!-- accept or dont -->
                <div class="pt-6 border-t border-gray-100 flex  gap-4">
                     <button type="submit" form="brandForm"
...
@push('scripts')
    @vite('resources/js/admin/brand/brand-create.js')
@endpush
