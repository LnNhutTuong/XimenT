                ...
                <div class="right w-1/2 ">
                    <div class="mt-2">
                        ...
                        <textarea name="address" id="customer_address" required
                            ...
                            class="w-full h-[193px] px-4 py-3 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all shadow-sm"></textarea>
                    </div> 
                </div>
                </div>
                ...
                <div class="w-1/2">
                    ...
                    <div class="p-4 bg-gray-50 border border-gray-200 flex justify-between items-center">
                            <div class="text-gray-700">
                                ...
                                <span id="total-quantity" class="font-bold text-black-600 ml-1">0</span>
                            </div>
                            <div class="text-gray-900">
                                <span class="text-lg font-medium">Tổng thanh toán:</span>
                                <span id="total-price" class="text-xl font-bold text-red-600 ml-2">0 VNĐ</span>
                            </div>
                        </div>
                </div>
                <div class="w-1/2">
